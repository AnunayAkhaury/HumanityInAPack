...
import blueBackground from '../public/bluebackdrop.jpg';  
    ...
    <section id="home">
      <div className="relative h-screen flex flex-col justify-center items-start bg-cover bg-center text-white">
        ...
        <div className="relative z-10 px-10 md:px-20">
          ...
          <button
            className="mt-6 bg-blue-500 text-white font-semibold py-2 px-6 rounded-full hover:bg-blue-700 transition-colors duration-300"
